...
def main():
    ...
    ordinary, train_ids, _ = build_dataset_from_protocol(args.train_protocol, args.train_data_path,
    ...
    print("Class weights: ordinary=[0.1,0.9]; paired=equal; one noisy view/source; "
          "21 training combinations / 6 held-out combinations")
    ...
    config.update(plan_id=PLAN_ID, initial_checkpoint_sha256=sha256(args.model_path),
                  ...
                  torch_version=str(torch.__version__), selection="0.3 clean Online + 0.35 noisy seen + 0.35 noisy heldout",
